(function () {
    ...
    // Pra religar: trocar PL_DESATIVADO para false e dar push.
    ...
    (function() {
        function injectPLBadge() {
            try {
                ...
                a.href = 'https://provoulevou.com.br?utm_source=widget&utm_medium=lojista&utm_campaign=maho';
                a.target = '_blank';
                a.rel = 'noopener';
    ...
    // ===============================================
    const apiKey = "pl_live_06eaadc8d258122868f404ae17410e30a12e459ce0d9d2b749222aa94ce31797";
    ...
    const html = `
        <div id="q-modal-ia">
            <div class="q-card-ia">
                ...
                <div class="q-content-scroll">
                    ...
                    <div id="q-loading-box">
                        <div class="q-loading-texts">
                            ...
                            <a href="https://provoulevou.com.br?utm_source=widget&utm_medium=lojista&utm_campaign=maho" target="_blank" class="q-loading-t2">
                ...
                <a href="https://provoulevou.com.br?utm_source=widget&utm_medium=lojista&utm_campaign=maho" target="_blank" class="q-powered-footer">
                    <span>Powered by</span>
            ...
            try {
                ...
                if (pending) {
                    ...
                    const resp = await fetch(WEBHOOK_PIX, {
                        method: 'POST',
                        headers: { 'Content-Type': 'application/json' },
                        body: JSON.stringify({ email: 'cliente@provoulevou.com.br', phone, loja: 'maho', origin: location.origin })
                    });
                    pix = await resp.json();
...
const fd = new FormData();
                    ...
                    console.log('[PL Maho] Enviando', allProdImgs.length, 'fotos do produto');
